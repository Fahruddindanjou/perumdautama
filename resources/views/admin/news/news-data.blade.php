    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title"><a href="{{route('news.index')}}" style="font-weight: bold">Berita </a>» Data Berita</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                    @foreach ($news as $result)
                        <tr>
                            ...
                            <td align="center">
                                <form action="{{route('news.delete', $result['slug'])}}" method="POST">
                                    @csrf
                                    @method("delete")
                                    <a href="{{route('news.edit', $result['slug'])}}" class="btn btn-success btn-sm">Edit</a>
